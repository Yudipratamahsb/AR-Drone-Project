...
namespace ARDrone.Control
{
	...
	{
		#region DroneControl Member Variables
		...
		/// 
		/// </remarks>
		#region DroneControl Constructor
		...
		#region DroneControl Initialization
		...
		#region DroneControl Connectionns
		...
		#region DroneControl Connection Sanity Check
