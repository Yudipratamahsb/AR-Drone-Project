...
#define H264_MAX_LEVEL_SUPPORTED 			31
#define H264_MAX_FRAME_WIDTH				1280
#define H264_MAX_FRAME_HEIGHT				720
#define H264_MAX_REF_FRAMES					3
#define H264_MAX_REORDER_FRAMES				3
#define H264_STRIDE							0
